...
def main():
    ...
    if use_reason_data:
        ...
        data_collator_synthetic = DataCollatorForSyntheticSentence(tokenizer=tokenizer, mlm_probability=args.mlm_probability)
        #data_collator_reason = DataCollatorForSyntheticSentenceReasoning(tokenizer=tokenizer, mlm_probability=args.mlm_probability)
        reason_train_dataloader = DataLoader(
            reason_train_dataset, shuffle=True, collate_fn=data_collator_synthetic, batch_size=args.per_device_reason_train_batch_size
        )
        reason_eval_dataloader = DataLoader(reason_eval_dataset, collate_fn=data_collator_synthetic, batch_size=args.per_device_reason_eval_batch_size)
