...
class XLMRobertaTokenizer(PreTrainedTokenizer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.entity_mask_token = "<entity_mask>"
        self.relation_mask_token = "<relation_mask>"
        self.fairseq_tokens_to_ids["<entity_mask>"] = self.fairseq_tokens_to_ids["<mask>"] + 1
        self.fairseq_tokens_to_ids["<relation_mask>"] = self.fairseq_tokens_to_ids["<mask>"] + 2
