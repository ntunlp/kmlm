...
class XLMRobertaTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(
        ...
        pad_token="<pad>",
        mask_token="<mask>",
        entity_mask_token="<entity_mask>",
        relation_mask_token="<relation_mask>",
        **kwargs
    ):
        # Mask token behave like a normal word, i.e. include the space before it
        mask_token = AddedToken(mask_token, lstrip=True, rstrip=False) if isinstance(mask_token, str) else mask_token
        entity_mask_token = AddedToken(entity_mask_token, lstrip=True, rstrip=False) if isinstance(entity_mask_token, str) else entity_mask_token
        relation_mask_token = AddedToken(relation_mask_token, lstrip=True, rstrip=False) if isinstance(relation_mask_token, str) else relation_mask_token
        ...
        super().__init__(
            ...
            relation_mask_token=relation_mask_token,
            **kwargs,
        )
